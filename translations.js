(() => {
  ...
  const messages = {
    zh: {
      ...
      'product.exchangeTierTitle': '查看阶梯汇率',
      'product.exchangeTierRange': '¥{min}–¥{max}：{rate}{fee}',
      'product.exchangeTierAbove': '¥{min} 以上：{rate}{fee}',
      'product.exchangeTierFee': ' + RM {fee}',
      ...
      'category.wallet.title': '人民币充值',
      'category.wallet.subtitle': '微信与支付宝人民币充值，输入金额后自动套用阶梯汇率。'
    },
    en: {
      ...
      'game.platformEyebrow': 'Top-Up System',
      'game.platformTitle': 'Choose Your Game System',
      'game.platformBody': 'Android and iOS have different products. Only matching prices will be shown.',
      'game.platformIos': 'Apple / iOS',
      'game.platformIosHint': 'View iOS products',
      'game.platformAndroid': 'Android',
      'game.platformAndroidHint': 'View Android products',
      'game.platformSharedNote': 'Slow top-up and platform-independent items will be shown for both systems.',
      ...
      'home.directoryAll': 'All Top-Up Games ({count})',
      'home.directoryFiltered': 'Filtered Games ({count})',
      'home.filterAll': 'All Games',
      'home.filterIntl': 'Global Games',
      'home.filterCn': 'China Games',
      'home.filterLive': 'Live Streaming',
      'home.filterWallet': 'RMB Top-Up',
      ...
      'product.exchangeAmountLabel': 'Enter the RMB amount to top up',
      'product.exchangeAmountPlaceholder': 'e.g. 1000',
      'product.exchangeAmountEmpty': 'Enter an amount to see the final price',
      'product.exchangeAmountPreview': 'Amount to Pay: {price}',
      'product.exchangeFee': ' + RM {fee} service fee',
      'product.exchangeAction': 'Add to Cart',
      'product.exchangeInvalid': 'Enter an RMB amount greater than 0.',
      'product.exchangeTierTitle': 'View Tiered Rates',
      'product.exchangeTierRange': '¥{min}–¥{max}: {rate}{fee}',
      'product.exchangeTierAbove': '¥{min} and above: {rate}{fee}',
      'product.exchangeTierFee': ' + RM {fee}',
      ...
      'contact.orderStatus': 'Order details copied',
      'contact.orderTitle': 'Choose How to Send Your Order',
      'contact.orderIntro': 'Send it directly through WhatsApp, or copy the order and paste it into WeChat. Pay only after our team confirms the details.',
      'contact.orderNoteLabel': 'Payment reminder: ',
      'contact.orderNote': 'Please wait for our team to confirm the order before making payment.',
      'contact.defaultTitle': 'Choose a Contact Method',
      'contact.defaultIntro': 'Contact Brilliant Gaming through WhatsApp or WeChat. Our team will help confirm the item, payment method, and top-up details.',
      'contact.inquiryTitle': 'Choose How to Send Your Inquiry',
      'contact.inquiryIntro': 'Send it through WhatsApp, or copy the inquiry and paste it into WeChat. Our team will confirm the latest price and method.',
      ...
      'contact.whatsappOrder': 'Order details included automatically',
      'contact.whatsappOpen': 'Recommended contact · Open WhatsApp',
      'contact.whatsappActionOrder': 'Open WhatsApp & Send Order',
      'contact.whatsappActionOpen': 'Open WhatsApp',
      'contact.wechatName': 'WeChat Support',
      'contact.wechatIdHelp': 'Copy the ID to add our support account',
      'contact.wechatOrderHelp': 'Copy and send it to us in WeChat',
      'contact.wechatInquiryHelp': 'Copy and send the inquiry in WeChat',
      'contact.wechatActionId': 'Copy WeChat ID',
      'contact.wechatActionOrder': 'Copy Order Details',
      'contact.wechatActionInquiry': 'Copy Inquiry',
      'contact.wechatCopied': 'WeChat ID copied',
      'contact.wechatOrderCopied': 'Order copied. You can now send it in WeChat.',
      'contact.wechatInquiryCopied': 'Inquiry copied. You can now send it in WeChat.',
      ...
      'category.wallet.title': 'RMB Top-Up',
      'category.wallet.subtitle': 'WeChat and Alipay RMB top-ups with automatic tiered-rate pricing.'
    }
  };
  ...
  const staticEnglish = {
    ...
    '充值资料 · 人民币充值': 'Top-Up Details · RMB Top-Up',
    '请填写微信或支付宝的收款账号与收款人名字；如需使用收款二维码，请在订单发送后另发给客服确认。': 'Enter the recipient WeChat or Alipay account and verified name. If you are using a payment QR code, send it separately to our team after submitting the order.',
    '收款账号 / 手机号码': 'Recipient Account / Mobile Number',
    '请输入微信号、支付宝账号或手机号码': 'Enter the WeChat ID, Alipay account, or mobile number',
    '收款人名字': 'Recipient Name',
    '请输入已实名的收款人名字': 'Enter the recipient’s verified name',
    '如使用收款二维码，请填写“二维码另发客服”（选填）': 'If using a payment QR code, enter “QR code will be sent separately” (optional)',
  ...
  const gameCatalog = {
    ...
    'shan-jiang-sanguo': { name: 'Shan Jiang Three Kingdoms', detail: 'Shan Jiang Three Kingdoms' },
    ...
    'delta-force-global-pc': { name: 'Delta Force Global (PC)', detail: 'Non-Garena · Delta Force Global (PC)' },
