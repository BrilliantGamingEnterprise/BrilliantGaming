...
function productMarkup(game) {
  if (game.platformSelector === true || game.platformSelector?.enabled === true) {
    return `<section class="game-platform-picker" aria-labelledby="gamePlatformTitle"><div class="game-platform-picker-copy"><span class="game-platform-eyebrow">充值系统</span><h2 id="gamePlatformTitle">请先选择游戏系统</h2><p>安卓与苹果的商品不同，选择后只会显示对应价格。</p></div><div class="game-platform-options" role="tablist" aria-label="请先选择游戏系统"><button class="game-platform-option" type="button" role="tab" aria-selected="false" data-game-platform="ios"><span class="game-platform-badge">iOS</span><span class="game-platform-option-copy"><strong>苹果 / iOS</strong><small>查看苹果系统商品</small></span><span class="game-platform-check" aria-hidden="true">✓</span></button><button class="game-platform-option" type="button" role="tab" aria-selected="false" data-game-platform="android"><span class="game-platform-badge">Android</span><span class="game-platform-option-copy"><strong>安卓 / Android</strong><small>查看安卓系统商品</small></span><span class="game-platform-check" aria-hidden="true">✓</span></button></div><p class="game-platform-shared-note">慢充与不分系统的商品会同时显示。</p></section><div class="game-platform-empty"><span aria-hidden="true">!</span><p>请先选择上方系统，避免购买错误的商品。</p></div>`;
  }
